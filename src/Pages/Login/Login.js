...
const Login = () => {
	...
	return (
		<div className="h-[800px] lg:flex justify-center items-center">
			<div>
				<img className="w-3/4" src={login} alt="" />
			</div>
			<div className="w-96 p-7 mr-5 bg-accent rounded-md">
				<h2 className="text-2xl font-extrabold text-transparent bg-clip-text text-center bg-gradient-to-r from-purple-400 to-pink-600">
					Login
				</h2>
